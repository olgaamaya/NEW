...
function loadMedia(lightboxId) {
    ...
    // Fetch the media for the lightbox
...
// Function to display media in the lightbox
...
// Automatically preload the first media of each lightbox on page load
document.addEventListener("DOMContentLoaded", function() {
    document.querySelectorAll('[id^="Lightbox_"]').forEach(lightbox => {
        const lightboxId = lightbox.id.replace('Lightbox_', '');
        loadMedia(lightboxId); // Preload media for each lightbox
    });
});
