    ...
    mediaFiles.forEach((media, index) => {
        ...
        if (media.src.endsWith(".mp4")) {
            ...
            const imageUrl = media.src
                .replace('/upload/', `/upload/c_fill,f_auto,q_auto,`) // Ensure correct transformations
                .replace(isMobile ? '/upload/' : '/upload/', isMobile ? '/upload/c_fill,f_auto,q_auto,w_600/' : '/upload/c_fill,f_auto,q_auto,w_1200/');
