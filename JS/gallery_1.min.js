...
function displayMediaFiles(mediaFiles, lightboxId, isMobile) {
    ...
    mediaFiles.forEach((media, index) => {
        ...
        if (media.src.endsWith(".mp4")) {
            ...
            // Apply Cloudinary transformations: resize, compress, and auto-format
            let imageUrl = media.src.replace('/upload/', '/upload/c_fill,f_auto,q_auto,');

            // Ensure the correct width for mobile vs desktop
            imageUrl = isMobile ?
                imageUrl.replace('/upload/', '/upload/c_fill,f_auto,q_auto,w_600/') :
                imageUrl.replace('/upload/', '/upload/c_fill,f_auto,q_auto,w_1200/');
